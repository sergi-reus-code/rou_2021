...
async function open_spy() {
    ...
    if (process.argv[2] == "pgcda") {
        child_process.exec("start \"spy\" cmd.exe /c node C:\\Users\\Sergi\\Desktop\\rou_2021\\prod\\spydefm.js pgcda parm2");


        if (process.argv[3] == "man") {
            child_process.exec("start \"spy\" cmd.exe /c node C:\\Users\\Sergi\\Desktop\\rou_2021\\prod\\spydefm.js pgcda parm2");
        } else {
            child_process.exec("start \"spy\" cmd.exe /c node C:\\Users\\Sergi\\Desktop\\rou_2021\\prod\\spydef888.js pgcda parm2");
        }
        ...
        child_process.exec("start \"spy\" cmd.exe /c node C:\\Users\\Sergi_Desktop\\Desktop\\5_rou_2021\\prod\\spydefm.js riu parm2");
    }
}
...
async function open_exec() {
    ...
    if (process.argv[2] == "pgcda") {
        child_process.exec("start \"exec\" cmd.exe /c node C:\\Users\\Sergi\\Desktop\\rou_2021\\prod\\exec888.js pgcda parm2");
    } else {
        child_process.exec("start \"exec\" cmd.exe /c node C:\\Users\\Sergi_Desktop\\Desktop\\5_rou_2021\\prod\\exec888.js riu parm2");
    }
...
function open_masterdef() {
    ...
    if (process.argv[2] == "pgcda") {
        child_process.exec("start \"masterdef\" cmd.exe /c node C:\\Users\\Sergi\\Desktop\\rou_2021\\prod\\masterdef.js pgcda parm2");
    } else {
        child_process.exec("start \"masterdef\" cmd.exe /c node C:\\Users\\Sergi_Desktop\\Desktop\\5_rou_2021\\prod\\masterdef.js riu parm2");
    }
